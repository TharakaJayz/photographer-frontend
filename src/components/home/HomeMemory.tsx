            ...
            opacity-0 home_memories_animation '>
                <div className='w-full bg-primary_light2 pl-vw10 rounded-xl rounded-l-none py-vh5 lg2_:pl-0 '>
                    <div className='w-full flex items-center justify-start gap-vw5   pr-vw5 lg2_:pr-0 md_:pr-0 md_:pl-0  md_:px-0 lg2_:px-vw1  lg_:gap-vw4 md_:gap-vw5  '>
                        <img src={'https://lh3.googleusercontent.com/pw/AP1GczNK8u4bLBIWPLnY30UZmFoZNIixtBd8756zksZ-QmNGycHeVQNtuybmp-tXKNY80GyCEB-ayikSVq-CCiRTYq5DyGCzoAR1Di4k6sqMvSOqVEYyEEo1j0p1wGLN5m-nFbI0-Oe6BCnk9K-Au0dGDS9C=w609-h913-s-no-gm?authuser=0'}  alt='memory' className='w-auto h-vh75 object-center object-cover rounded-3xl md_:hidden lg2_:h-auto lg2_:w-vw40 ' />
